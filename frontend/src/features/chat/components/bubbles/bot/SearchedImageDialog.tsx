...
import { useImageDialogStore } from "@/stores/imageDialogStore";

export default function SearchedImageDialog() {
  const { isOpen, selectedImage, closeImageDialog } = useImageDialogStore();

  return (
    <Sheet open={isOpen} onOpenChange={() => closeImageDialog()}>
      <SheetContent
        side="right"
