...
export default function Personalised() {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-10">
      <div className="flex w-full max-w-5xl flex-col justify-center p-7">
        ...
        <div className="grid w-full max-w-4xl grid-cols-2 grid-rows-1 justify-between gap-7 py-10">
          <BentoItem
