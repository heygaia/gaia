---
title: "Installation"
description: "Install the GAIA CLI tool using npm, pnpm, or bun to set up and manage your GAIA instance from the terminal."
icon: "download"
---

<Frame>
  <img src="/images/cli.webp" alt="GAIA CLI terminal interface" />
</Frame>
...
<CardGroup cols={2}>
  ...
  <Card title="Device Bridge" icon="plug" href="/cli/device-bridge">
    Connect your machine's local MCP servers and files to GAIA
  </Card>
</CardGroup>
